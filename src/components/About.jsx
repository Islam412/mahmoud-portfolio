          ...
          >
            <div className="grid grid-cols-2 gap-4">
              <div className="overflow-hidden rounded-2xl">
                <img src="https://placehold.co/400x400/16213e/e94560/png?text=Mahmoud+1" className="w-full h-64 object-cover" />
              </div>
              <div className="overflow-hidden rounded-2xl mt-8">
                <img src="https://placehold.co/400x400/16213e/533483/png?text=Mahmoud+2" className="w-full h-64 object-cover" />
              </div>
              <div className="overflow-hidden rounded-2xl col-span-2">
                <img src="https://placehold.co/800x300/16213e/e94560/png?text=Mahmoud+Work" className="w-full h-48 object-cover" />
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-3 mb-8">
              <div className="glass-effect rounded-xl p-3 text-center">
                ...
                <p className="text-white text-sm">تصميم لوحات</p>
              </div>
              <div className="glass-effect rounded-xl p-3 text-center">
                <span className="text-accent-primary text-2xl">🏷️</span>
                <p className="text-white text-sm">تصميم لوجو</p>
              </div>
              <div className="glass-effect rounded-xl p-3 text-center">
                <span className="text-accent-primary text-2xl">📱</span>
                <p className="text-white text-sm">سوشيال ميديا</p>
              </div>
              <div className="glass-effect rounded-xl p-3 text-center">
                <span className="text-accent-primary text-2xl">🖨️</span>
                <p className="text-white text-sm">مطبوعات</p>
              </div>
              <div className="glass-effect rounded-xl p-3 text-center col-span-2">
                <span className="text-accent-primary text-2xl">🏢</span>
                <p className="text-white text-sm">وجهات كلادينج</p>
              </div>
            </div>
          </motion.div>
        </div>
